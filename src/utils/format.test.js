...
describe('formatNumberWithLocale', () => {
  it('should format number according to user locale', () => {
  ...
  it('should default to en-US locale if user locale is not detected', () => {
...
describe('formatMinutes', () => {
  it('should format minutes into days and hours without remainder', () => {
    expect(formatMinutes(120, false)).toBe('2h')
    expect(formatMinutes(1440, false)).toBe('1d')
  })

  it('should format minutes into days and hours', () => {
